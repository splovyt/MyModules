...
from helperfunctions.tokenize import tokenize
from helperfunctions.levenshtein_distance import levenshtein_distance

class SpellingCorrector:
    
    def __init__(self, sentence_database: Iterable[str], trained_word2vec_model: KeyedVectors, 
                 mismatches_allowed: int, vocabulary = None):
    ...
    def __tokens_list_to_ngrams(self, tokens_list: list, n: int) -> dict:
    ...
    def best_ngram_match(self, tokens: Iterable[str], ngram_database: dict, max_length_difference = 10) -> tuple:
    ...
    def unrecognized_words(self, tokens: Iterable[str]) -> list:
    ...
    def __correct_ngram_with_database(self, ngram: Iterable[str], database: dict) -> list:
    ...
    def __ngram_spelling_proofer(self, tokens: Iterable[str], unrecognized_tokens: Iterable[str]) -> list:
